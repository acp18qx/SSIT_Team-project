...
<u><h2>Blast Off: the Straight-ish Line Speed Test</h2></u>
...
<div class="form-group">
    <label >Team Name</label>
     ...
     <select class="form-group" id="controlmethod">
		<%
	  ResultSet r2= s1.executeQuery("select distinct teamName from schedule where challenge='Speed'");
...
<table id="table4">
 ...
 <div class="form-group">
	...
	<input type="checkbox" name="zonecount" value="yes" style="transform: scale(1.5);">  </br>
</div>
 <div class="form-group">
   
    <label>Runs Without touching any Side : </label>
	<input type="checkbox" name="zonecount" value="yes" style="transform: scale(1.5);">  </br>
</div>
  
   <div class="form-group">
    <label >Touch Walls : </label>
 ...
 <div class="form-group">
    ...
    <label>Scrapping along the walls : </label>
	<input type="checkbox" name="zonecount" value="yes" style="transform: scale(1.5);">  </br>
</div>

 <div class="form-group">
    <label >Number of Rescues : </label>
    <input type="radio" name="zonecount" value="yes" style="transform: scale(1.5);"> 1 &nbsp;
  <input type="radio" name="zonecount" value="no" style="transform: scale(1.5);"> 2 &nbsp;
   <input type="radio" name="zonecount" value="yes" style="transform: scale(1.5);"> 3 or more &nbsp;
</div>

<div class="form-group">
   
    <label>Abandoned or non-completed run : </label>
	<input type="checkbox" name="zonecount" value="yes" style="transform: scale(1.5);">  </br>
</div>
